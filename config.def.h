...
// Font:pixelsize=18:antialias=true:autohint=true";
static char *font =
    "JetBrainsMono Nerd "
    "Font:pixelsize=22:antialias=true:autohint=true:style:medium";
...
static Shortcut shortcuts[] = {
    ...
    {MODKEY, XK_k, kscrollup, {.i = 10}},
    {MODKEY, XK_j, kscrolldown, {.i = 10}},
};
